...
private String accessToken;
	...
	public void deleteContactTest() {
		...
		Response responseDel = restClient.delete(BASE_URL_CONTACTS, CONTACTS_ENDPOINT+"/"+contactId, ContentType.JSON, AuthType.BEARER_TOKEN, null, null);
		Assert.assertEquals(responseDel.statusLine(), "HTTP/1.1 200 OK");
		Assert.assertEquals(responseDel.statusCode(), 200);
		Assert.assertEquals(responseDel.getBody().asString(), "Contact deleted");
